...
class ChatServer:
    ...
    def change_password_dialog(self, tree):
        ...
        # 旧密码输入
        ttk.Label(input_frame, text="旧密码:").grid(row=1, column=0, sticky=W, padx=5, pady=5)
        old_password_entry = ttk.Entry(input_frame, show="*")
        old_password_entry.grid(row=1, column=1, sticky=(W, E), padx=5, pady=5)
        
        # 新密码输入
        ttk.Label(input_frame, text="新密码:").grid(row=2, column=0, sticky=W, padx=5, pady=5)
        new_password_entry = ttk.Entry(input_frame, show="*")
        new_password_entry.grid(row=2, column=1, sticky=(W, E), padx=5, pady=5)
        
        # 确认新密码输入
        ttk.Label(input_frame, text="确认新密码:").grid(row=3, column=0, sticky=W, padx=5, pady=5)
        confirm_new_password_entry = ttk.Entry(input_frame, show="*")
        confirm_new_password_entry.grid(row=3, column=1, sticky=(W, E), padx=5, pady=5)
        ...
        change_btn = ttk.Button(btn_frame, text="修改", 
                               command=lambda: self.change_password(username_entry.get(), old_password_entry.get(), new_password_entry.get(), confirm_new_password_entry.get(), change_window, tree))
